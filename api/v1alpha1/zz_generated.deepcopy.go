...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessRight) DeepCopyInto(out *AccessRight) {
	*out = *in
	if in.Versions != nil {
		in, out := &in.Versions, &out.Versions
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessRight.
func (in *AccessRight) DeepCopy() *AccessRight {
	if in == nil {
		return nil
	}
	out := new(AccessRight)
...
func (in *CredentialSpec) DeepCopyInto(out *CredentialSpec) {
	*out = *in
	if in.AccessRights != nil {
		...
		*out = make(map[string]AccessRight, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.ApplyPolicies != nil {
		in, out := &in.ApplyPolicies, &out.ApplyPolicies
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ApplyPolicyRefs != nil {
		in, out := &in.ApplyPolicyRefs, &out.ApplyPolicyRefs
		*out = make([]SecurityPolicyNamespacedName, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecurityPolicyNamespacedName) DeepCopyInto(out *SecurityPolicyNamespacedName) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecurityPolicyNamespacedName.
func (in *SecurityPolicyNamespacedName) DeepCopy() *SecurityPolicyNamespacedName {
	if in == nil {
		return nil
	}
	out := new(SecurityPolicyNamespacedName)
	in.DeepCopyInto(out)
	return out
}
